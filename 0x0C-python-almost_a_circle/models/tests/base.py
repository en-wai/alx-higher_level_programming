...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """Returning json string representation of list of dictionaries 15"""
    ...
    def save_to_file(cls, list_objs):
        """Saving list of objects to file 16"""
    ...
    def from_json_string(json_string):
        """Returning list of objects from json string 17"""
    ...
    def create(cls, **dictionary):
        """Creating an instance of class Base 18"""
        if cls.__name__ == 'Rectangle':
    ...
    def load_from_file(cls):
        """Loading list of objects from file 19"""
